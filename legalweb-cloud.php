 ...
 * Description:   Wordpress Plugin for GDPR/DSGVO, Imprint & Pricacy Policy and other legal texts to use with the legalweb.io cloud service.
 * Version:       1.0.4
 * Author:        legalweb
...
define('legalweb_cloud_VERSION', '1.0.4');
